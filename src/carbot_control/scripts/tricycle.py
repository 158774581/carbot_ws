...
class Acker():
    def __init__(self):
        ...
        self.joints = rospy.get_param("~steered_joints",
                                       [{'link': 'front_center_steer',
                                         'steer_joint': 'front_center_steer_joint',
                                         'steer_topic': '/carbot/front_center/steer_position_controller/command',
                                         'wheel_joint': 'wheel_front_center_axle',
                                         'wheel_topic': '/carbot/front_center/wheel_position_controller/command'},
                                        {'link': 'back_left',
                                         'steer_joint': None,
                                         'steer_topic': None,
